...
$JavaPath = "C:\Program Files\Eclipse Adoptium\jre-17.0.8.101-hotspot"
#######################################
$error.clear()
...
$CurDate = Get-Date -Format "ddMMyyyy-HHmmss"
...
if (-Not (Test-Path $ScriptConfig)){
    ...
    Add-Content -Path $ScriptConfig -Value "JavaPath - Enter custom Java Path"
